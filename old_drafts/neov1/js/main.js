...
console.log('%c👋 Hey there, developer!', 'font-size: 20px; font-weight: bold; color: #FF6B6B;');
console.log('%cInterested in the code? Check out the repository!', 'font-size: 14px; color: #4ECDC4;');
console.log('%cBuilt with ❤️ using Neo-Brutalism design principles', 'font-size: 12px; color: #000;');
